...
// ═══════════════════════════════════════════════════════════════════════════
    ...
    constexpr uint32_t BAUD_SERIAL  = 115200;  // USB serial debug, silício real
#else
    ...
    constexpr uint32_t BAUD_SERIAL  = 9600;    // Proteus simula UNO devagar — 115200 perde bits
#endif
...
constexpr uint16_t      N_AMOSTRAS_ONDA   = 32;       // ~2 períodos de 60Hz a 1kHz
constexpr uint16_t      PERIODO_ONDA_US   = 1000;     // 1 ms → 1 kHz
...
constexpr float LIMIAR_INRUSH_VPICO         = 1.50f;
...
constexpr const char* TOPICO_ONDA_P      = "onda_corrente_primario";
constexpr const char* TOPICO_ONDA_S      = "onda_corrente_secundario";
